...
Action: file_editor create /app/frontend/src/components/MagneticButton.jsx --file-text "import { useRef, useState } from \"react\";
...
export const MagneticButton = ({ children, className = \"\", onClick, variant = \"primary\", ...props }) => {
  ...
  const variants = {
    ...
    ghost:
      \"text-foreground bg-white/60 dark:bg-white/5 border border-black/10 dark:border-white/10 hover:bg-white/90 dark:hover:bg-white/10 hover:-translate-y-0.5\",
  };
...
"
Observation: Create successful: /app/frontend/src/components/MagneticButton.jsx