    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-white dark:bg-brand-dark-bg"
        >
          ...
          <div className="relative flex flex-col items-center gap-8">
            ...
            >
              <div className="text-2xl font-bold tracking-tight font-display">
                ...
                <span className="text-brand-text dark:text-white">021</span>
              </div>
              ...
              <div className="text-xs uppercase tracking-[0.3em] text-brand-muted dark:text-brand-dark-muted">
