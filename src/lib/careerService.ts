...
export async function getCareerPaths(): Promise<CareerPathRow[]> {
  const { data, error } = await supabase
    .from('career_paths')
    .select('id, icon, title, short_description, full_description, average_salary, career_growth, education_required, required_skills, industries, future_scope, created_at')
